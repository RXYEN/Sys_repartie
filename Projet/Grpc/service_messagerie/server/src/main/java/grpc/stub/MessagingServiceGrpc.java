...
public final class MessagingServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.stub.Service.Nickname,
      grpc.stub.Service.ServerResponse> getSubscriptionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "subscription",
      requestType = grpc.stub.Service.Nickname.class,
      responseType = grpc.stub.Service.ServerResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpc.stub.Service.Nickname,
      grpc.stub.Service.ServerResponse> getSubscriptionMethod() {
    io.grpc.MethodDescriptor<grpc.stub.Service.Nickname, grpc.stub.Service.ServerResponse> getSubscriptionMethod;
      ...
      synchronized (MessagingServiceGrpc.class) {
        if ((getSubscriptionMethod = MessagingServiceGrpc.getSubscriptionMethod) == null) {
          MessagingServiceGrpc.getSubscriptionMethod = getSubscriptionMethod = 
              io.grpc.MethodDescriptor.<grpc.stub.Service.Nickname, grpc.stub.Service.ServerResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "MessagingService", "subscription"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.stub.Service.Nickname.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.stub.Service.ServerResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.stub.Service.Empty,
      grpc.stub.Service.connectedUser> getShowonlineMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "showonline",
      requestType = grpc.stub.Service.Empty.class,
      responseType = grpc.stub.Service.connectedUser.class,
      methodType = io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
  public static io.grpc.MethodDescriptor<grpc.stub.Service.Empty,
      grpc.stub.Service.connectedUser> getShowonlineMethod() {
    io.grpc.MethodDescriptor<grpc.stub.Service.Empty, grpc.stub.Service.connectedUser> getShowonlineMethod;
      ...
      synchronized (MessagingServiceGrpc.class) {
        if ((getShowonlineMethod = MessagingServiceGrpc.getShowonlineMethod) == null) {
          MessagingServiceGrpc.getShowonlineMethod = getShowonlineMethod = 
              io.grpc.MethodDescriptor.<grpc.stub.Service.Empty, grpc.stub.Service.connectedUser>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "MessagingService", "showonline"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.stub.Service.Empty.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.stub.Service.connectedUser.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<grpc.stub.Service.content,
      grpc.stub.Service.content> getChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "chat",
      requestType = grpc.stub.Service.content.class,
      responseType = grpc.stub.Service.content.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<grpc.stub.Service.content,
      grpc.stub.Service.content> getChatMethod() {
    io.grpc.MethodDescriptor<grpc.stub.Service.content, grpc.stub.Service.content> getChatMethod;
    if ((getChatMethod = MessagingServiceGrpc.getChatMethod) == null) {
      synchronized (MessagingServiceGrpc.class) {
        if ((getChatMethod = MessagingServiceGrpc.getChatMethod) == null) {
          MessagingServiceGrpc.getChatMethod = getChatMethod = 
              io.grpc.MethodDescriptor.<grpc.stub.Service.content, grpc.stub.Service.content>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "MessagingService", "chat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.stub.Service.content.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpc.stub.Service.content.getDefaultInstance()))
  ...
  public static abstract class MessagingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void subscription(grpc.stub.Service.Nickname request,
        io.grpc.stub.StreamObserver<grpc.stub.Service.ServerResponse> responseObserver) {
      asyncUnimplementedUnaryCall(getSubscriptionMethod(), responseObserver);
    }

    /**
     */
    public void showonline(grpc.stub.Service.Empty request,
        io.grpc.stub.StreamObserver<grpc.stub.Service.connectedUser> responseObserver) {
      asyncUnimplementedUnaryCall(getShowonlineMethod(), responseObserver);
    }

    /**
     */
    public io.grpc.stub.StreamObserver<grpc.stub.Service.content> chat(
        io.grpc.stub.StreamObserver<grpc.stub.Service.content> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpc.stub.Service.Nickname,
                grpc.stub.Service.ServerResponse>(
                  this, METHODID_SUBSCRIPTION)))
          .addMethod(
            getShowonlineMethod(),
            asyncServerStreamingCall(
              new MethodHandlers<
                grpc.stub.Service.Empty,
                grpc.stub.Service.connectedUser>(
                  this, METHODID_SHOWONLINE)))
          .addMethod(
            getChatMethod(),
            asyncBidiStreamingCall(
              new MethodHandlers<
                grpc.stub.Service.content,
                grpc.stub.Service.content>(
                  this, METHODID_CHAT)))
          .build();
    }
  ...
  public static final class MessagingServiceBlockingStub extends io.grpc.stub.AbstractStub<MessagingServiceBlockingStub> {
    ...
    /**
     */
    public grpc.stub.Service.ServerResponse subscription(grpc.stub.Service.Nickname request) {
    ...
    /**
     */
    public java.util.Iterator<grpc.stub.Service.connectedUser> showonline(
        grpc.stub.Service.Empty request) {
  ...
  public static final class MessagingServiceFutureStub extends io.grpc.stub.AbstractStub<MessagingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpc.stub.Service.ServerResponse> subscription(
        grpc.stub.Service.Nickname request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SUBSCRIPTION:
          serviceImpl.subscription((grpc.stub.Service.Nickname) request,
              (io.grpc.stub.StreamObserver<grpc.stub.Service.ServerResponse>) responseObserver);
          break;
        case METHODID_SHOWONLINE:
          serviceImpl.showonline((grpc.stub.Service.Empty) request,
              (io.grpc.stub.StreamObserver<grpc.stub.Service.connectedUser>) responseObserver);
          break;
        default:
  ...
  private static abstract class MessagingServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpc.stub.Service.getDescriptor();
    }
